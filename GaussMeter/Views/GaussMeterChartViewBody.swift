...
struct GaussMeterChartViewBody: View {
        ...
        VStack(alignment: .center){
            HStack{
                ...
                Image(systemName: "location.north.circle")
                    ...
                    .rotationEffect(Angle(degrees: -magnetometer.heading.trueHeading))
            }
...
struct GaussMeterChartViewBody_Previews: PreviewProvider {
    static var previews: some View {
        GaussMeterChartViewBody().environmentObject(MagnetometerCommunicator())
    }
}
